...
class AppColors {
  ...
  static final Color mainColor = const Color(0xFF3BA4EA);
  static final Color demoColor = const Color(0xFF89dad0);
  ...
  static final Color greenColor = const Color(0xFF3CB371);
}
